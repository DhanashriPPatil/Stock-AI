      ...
      {!selectedStock ? (
        ...
        <div className="flex-1 flex flex-col justify-center py-6 space-y-6 relative z-10 animate-fadeIn">
          ...
          <div className="relative font-mono">
            <label className="text-[9.5px] font-black text-dash-muted uppercase tracking-widest block mb-2 font-semibold">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-xs pl-9 pr-3.5 py-2 bg-slate-950/60 border border-white/[0.08] rounded-xl text-white placeholder-dash-muted focus:outline-none focus:border-dash-primary/60 focus:ring-1 focus:ring-dash-primary/40 transition-all font-sans"
              />
            </div>
        ...
        <div className="flex-1 flex flex-col space-y-5 animate-fadeIn relative z-10 overflow-y-auto pr-1">
          ...
          <div className="p-3 bg-white/[0.03] border border-white/[0.06] rounded-2xl flex items-center justify-between">
            <div>
              ...
              <h4 className="text-xs font-black text-white mt-1.5 truncate max-w-[160px] font-sans">
          ...
          <div>
            <label className="text-[9.5px] font-black text-dash-muted uppercase tracking-widest block mb-2 font-mono font-semibold">
              Analytical Lens:
            </label>
          ...
          <div className="space-y-2 font-mono">
            <span className="text-[9.5px] font-black text-dash-muted uppercase tracking-widest block font-semibold">
