      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-dash-card p-4 rounded-xl border border-dash-line">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          >
            ...
            <option value="durability_desc">
              🛡️ DURABILITY SCORE [High ➔ Low]
            </option>
            <option value="valuation_desc">
              💎 VALUATION SCORE [High ➔ Low]
            </option>
            <option value="roe_desc">
              📊 RETURN ON EQUITY (ROE) [High ➔ Low]
            </option>
            <option value="pe_asc">
              🔑 P/E RATIO [Low ➔ High]
            </option>
