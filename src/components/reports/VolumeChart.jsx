  ...
  return (
    <div className="space-y-6 select-none animate-fadeIn font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-5 bg-dash-card border border-dash-line rounded-2xl flex flex-col justify-between font-mono">
          <div>
      ...
      <div className="p-5 bg-dash-card border border-dash-line rounded-2xl">
        <div className="flex items-center justify-between border-b border-dash-line pb-3 mb-4 font-mono">
          ...
          <span className="text-[8px] font-mono text-dash-muted uppercase font-semibold">
            NSE Volume Tracker
          </span>
        </div>
