...
export const PredictionChart = ({ stock }) => {
  ...
  return (
    <div className="p-5 bg-dash-card border border-dash-line rounded-2xl select-none animate-fadeIn font-semibold">
      {/* Title block */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-4 border-t border-dash-line font-mono text-xxs">
        <div>
          <span className="text-dash-muted block font-semibold font-semibold">
        ...
        <div>
          <span className="text-dash-muted block font-semibold font-semibold font-semibold">AI DRIFT STRETCH RATE:</span>
