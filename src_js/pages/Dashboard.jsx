  ...
  return (
    <div id="dashboard_page" className="space-y-8 select-none">
      ...
      <motion.div
        ...
        className="relative bg-gradient-to-r from-teal-500/10 via-dash-primary/10 to-transparent border border-dash-primary/20 hover:border-dash-primary/40 rounded-2xl p-4 md:p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all overflow-hidden group shadow-[0_0_20px_rgba(0,194,255,0.02)]"
      >
        <div className="flex items-start gap-3.5">
          <div className="w-11 h-11 rounded-xl bg-dash-primary/15 border border-dash-primary/30 flex items-center justify-center text-dash-primary shrink-0 group-hover:scale-105 transition-transform">
            <Sparkles className="w-5.5 h-5.5 animate-pulse text-[#fbbf24]" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[9px] font-mono font-black text-[#fbbf24] bg-[#fbbf24]/10 border border-[#fbbf24]/20 py-0.5 px-2 rounded-full uppercase tracking-wider">
                FEATURED REPORT
              </span>
            ...
            <p className="text-[11px] text-dash-muted max-w-2xl leading-relaxed">
              Explore professional market assessments from Stoxbox: Rotation
              grids, market breadth DMA trends, options open interest support,
              and the BEL technical strong buy report.
            </p>
          </div>
        </div>
        <Link
          to="/weekly-wealth"
          className="text-xxs font-black font-mono tracking-widest bg-dash-primary text-black py-2.5 px-4 rounded-xl hover:bg-white hover:text-black transition-all shadow-[0_4px_15px_rgba(0,194,255,0.25)] flex items-center gap-1.5 shrink-0 uppercase self-end md:self-center cursor-pointer"
        >
          EXPLORE REPORT <ArrowUpRight className="w-3.5 h-3.5 stroke-[2.5]" />
        </Link>
      </motion.div>
      ...
      >
        <div className="flex items-start gap-3.5">
          <div className="w-11 h-11 rounded-xl bg-dash-primary/15 border border-dash-primary/30 flex items-center justify-center text-dash-primary shrink-0 group-hover:scale-105 transition-transform">
            <Globe className="w-5.5 h-5.5 text-sky-400 rotate-6" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[9px] font-mono font-black text-sky-400 bg-sky-400/10 border border-sky-400/20 py-0.5 px-2 rounded-full uppercase tracking-wider">
            ...
            <p className="text-[11px] text-dash-muted max-w-2xl leading-relaxed">
              Explore Academic, Research-Style Summaries of global commodity
              changes: US-Iran geopolitical choke-points, 42-month peak WPI,
              crude spikes, and multi-sector equity adjustments.
            </p>
          </div>
        </div>
        <Link
          ...
          className="text-xxs font-black font-mono tracking-widest bg-dash-primary text-black py-2.5 px-4 rounded-xl hover:bg-white hover:text-black transition-all shadow-[0_4px_15px_rgba(0,194,255,0.25)] flex items-center gap-1.5 shrink-0 uppercase self-end md:self-center cursor-pointer"
        >
          ANALYZE MACRO <ArrowUpRight className="w-3.5 h-3.5 stroke-[2.5]" />
        </Link>
      </motion.div>
      ...
      >
        <div className="flex items-start gap-3.5">
          <div className="w-11 h-11 rounded-xl bg-dash-primary/15 border border-dash-primary/30 flex items-center justify-center text-dash-primary shrink-0 group-hover:scale-105 transition-transform">
            <Building2 className="w-5.5 h-5.5 text-purple-400 group-hover:rotate-12 transition-transform" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[9px] font-mono font-black text-purple-400 bg-purple-500/10 border border-purple-400/20 py-0.5 px-2 rounded-full uppercase tracking-wider">
            ...
            <p className="text-[11px] text-dash-muted max-w-2xl leading-relaxed">
              Analyze physical metal tightness inside LME backwardation curves,
              smelter outages, steel mill delivery premium bounds, and the
              transition of IT services toward active decision support
              platforms.
            </p>
          </div>
        </div>
        <Link
          ...
          className="text-xxs font-black font-mono tracking-widest bg-dash-primary text-black py-2.5 px-4 rounded-xl hover:bg-white hover:text-black transition-all shadow-[0_4px_15px_rgba(0,194,255,0.25)] flex items-center gap-1.5 shrink-0 uppercase self-end md:self-center cursor-pointer"
        >
          ANALYZE SECTORS <ArrowUpRight className="w-3.5 h-3.5 stroke-[2.5]" />
        </Link>
      </motion.div>
