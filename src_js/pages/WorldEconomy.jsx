    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {macroIndicators.map((ind, i) => (
          ...
          >
            <div>
              <span className="text-[10px] text-dash-muted block uppercase tracking-wider font-bold mb-1">
                {ind.label}
              </span>
      ...
      <div className="mt-4">
        ...
        {activeTab === "macro" && (
          ...
          >
            <div className="glass-premium p-6 rounded-2xl space-y-4">
              <div className="flex items-center justify-between border-b border-dash-line pb-3">
                <h3 className="text-xs font-black tracking-widest text-[#f8fafc] uppercase font-mono">
                  Geopolitical Shockwaves Analysis
                </h3>
                <span className="text-[9px] font-mono bg-dash-danger/10 text-dash-danger px-2 py-0.5 border border-dash-danger/20 rounded font-black uppercase">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="glass-premium p-5 rounded-xl space-y-3">
                <span className="text-[10px] text-dash-danger font-mono font-black uppercase tracking-wider block">
              ...
              <div className="glass-premium p-5 rounded-xl space-y-3 text-xs text-dash-ink">
                ...
                <div className="bg-dash-bg/50 border border-dash-line p-3 rounded-lg font-mono text-[10px] space-y-1.5 text-dash-muted">
                  <div className="flex justify-between">
                    <span className="font-bold">BRENT CRUDE OILS:</span>
                    <span className="text-white font-bold font-mono">
                      $105.77 / BBL (+0.13%)
                    </span>
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="glass-premium p-5 rounded-2xl space-y-3">
                ...
                <p className="text-xs text-dash-ink leading-relaxed text-justify">
              ...
              <div className="glass-premium p-5 rounded-2xl space-y-3">
                <span className="text-[10px] text-[#fbbf24] font-mono font-black uppercase tracking-wider block">
        ...
        {activeTab === "flows" && (
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="glass bg-dash-surface-dark border border-white/[0.04] p-6 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="glass-premium p-5 rounded-xl space-y-4">
                ...
                <div className="space-y-3.5">
                  {capitalFlows.map((flow, idx) => (
                    ...
                    >
                      <span className="text-xs font-bold text-dash-muted uppercase">
                        {flow.segment}
                      </span>
                      <span
              ...
              <div className="glass-premium p-5 rounded-xl space-y-4 text-xs text-dash-ink">
                <span className="text-[10px] text-dash-warning font-mono font-black uppercase tracking-wider block">
        ...
        {activeTab === "technicals" && (
          ...
          >
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="glass-premium p-5 rounded-2xl border border-dash-line shadow-lg space-y-4">
                <span className="text-[10px] text-dash-primary font-mono font-black uppercase tracking-wider block pb-2 border-b border-dash-line">
                  Index Assessment Limits
                </span>

                <div className="space-y-3.5">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-dash-muted uppercase font-bold text-[10px]">
                      PCR (Open Interest)
                    </span>
