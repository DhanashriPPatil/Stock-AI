...
export const CategoryCard = ({ id, name, description, count, avgMomentum }) => {
  const configs = {
    ...
    intraday: {
      ...
      icon: TrendingUp,
      iconColor: "text-rose-400 fill-rose-400/10",
      ...
      >
        ...
        <div>
          <div className="flex items-start justify-between">
            ...
            <span
              className={`text-[9px] font-black tracking-widest font-mono uppercase px-2.5 py-1 rounded-full border ${configs.pill}`}
            >
              {count} STOCKS FOUND
            </span>
          </div>
          ...
          <div className="mt-5">
            <h3 className="text-base font-black tracking-tight text-white font-display uppercase leading-none">
              {name}
            </h3>
        ...
        <div className="mt-6 pt-4 border-t border-[rgba(255,255,255,0.06)] flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-bold text-white uppercase tracking-wider font-mono">
            ACCESS SCREEN
