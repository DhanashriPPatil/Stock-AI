    ...
    >
      <div>
        ...
        <div className="mt-4 flex items-baseline gap-2">
          ...
          <span className="text-xxs text-dash-ink font-mono font-bold uppercase leading-none">
            Bullish Equity Bias
          </span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mt-6 pt-4 border-t border-dash-line font-mono text-xxs">
        <div>
          <span className="text-dash-muted block">AVG DAY-RSI:</span>
          <span className="text-xs font-black text-white mt-0.5 block">
            {stats.avgRsi.toFixed(1)}
          </span>
        </div>
        <div>
          <span className="text-dash-muted block">AVG MOMENTUM:</span>
          <span className="text-xs font-black text-white mt-0.5 block">
