    ...
    <div className="space-y-6 select-none animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="p-5 bg-dash-card border border-dash-line rounded-2xl md:col-span-1 flex flex-col justify-between">
          <div>
            <div className="text-[10px] text-dash-muted font-mono font-black uppercase mb-3">
          ...
          {newsStories.map((story) => (
            ...
            >
              <div>
                ...
                <h5 className="text-xs font-bold text-white font-display mt-3 leading-snug hover:text-dash-primary transition-colors cursor-pointer">
                  {story.title}
                </h5>
                <p className="text-[10.5px] text-dash-ink mt-2.5 leading-relaxed">
                  {story.snippet}
                </p>
              </div>
